...
BEGIN
  ...
  LOOP
    ...
    -- Match EXATO das linhas sintéticas ('caixa','proventos','cash') — evita falso-positivo
    -- em fundos "V8 Cash", "Trend Cash", "AMW Cash Clash" e na ação CXSE3 ("CAIXA SEGURI ON").
    ...
    -- Fundos fechados (liquidez_fechada = true) NÃO contam como sem liquidez.
    -- Linhas sintéticas ('caixa','proventos','cash', match exato) também NÃO contam.

...
import { TrendingUp, Users, ArrowRight, Search, Settings, CheckCircle2, AlertCircle, Settings2 } from "lucide-react";
...
export default function ClientList() {
  ...
  // Função para calcular a última competência esperada (último mês fechado)
  ...
  // Função para calcular quantos meses de diferença
  ...
  const handleManageDataClick = (clientName: string, e: React.MouseEvent) => {
    e.stopPropagation();
        ...
        {!loading && clientsStatus.length > 0 && (
          <div className="mb-12">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-foreground">Gestão de Dados</h2>
            </div>
            <p className="text-muted-foreground mb-6">
              ...
              {clientsStatus.map((status) => {
                ...
                return (
                  <Card 
                    ...
                    onClick={(e) => handleManageDataClick(status.cliente, e)}
                  >
